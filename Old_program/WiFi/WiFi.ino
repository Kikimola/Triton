...
const int oneWire_Pin = 32; // порт термометра   // проверить
const int An_IN1_Pin = 33; // порт датчика давления // проверить
...
void loop()
{
    ...
    if(1) 
    {
        _Presh= analogRead(An_IN1_Pin)*0.99;
        if (_Presh > Range_P)
        {
